#!/usr/bin/python3
"""This is an interactive consle environment for the Utibu_Health Api
You can do a few tasks like show all medication records.
...
class RESTCommand(cmd.Cmd):
    ...
    prompt = 'Med() ' if sys.__stdin__.isatty() else ''

    classes = {
               'BaseModel': BaseModel, 'Medicine': Medicine
              }
    ...
    def do_quit(self, command):
        """ Method to exit the REST console"""
        exit()
